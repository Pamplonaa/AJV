 ...
 * @author Pizetta
 */
public class TelaEditarAtividade extends javax.swing.JFrame {

    /**
     * Creates new form TelaEditarAtividade
     */
    public TelaEditarAtividade() {
        initComponents();
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        try {
            ControladorAtividade.getInstance().editarAtividade();
        } catch (NoSuchAlgorithmException ex) {
            Logger.getLogger(TelaEditarAtividade.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_btSalvarActionPerformed

    private void btCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCancelarActionPerformed
        ControladorAtividade.getInstance().fechaTelaEditarAtividade();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaEditarAtividade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaEditarAtividade().setVisible(true);
            }
        });
    }
    ...
    public boolean popularAtividade(Atividade atividade) {
        if (atividade == null) {
